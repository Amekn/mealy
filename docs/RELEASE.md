...
1. Confirm the copyright-holder-selected canonical Apache-2.0 `LICENSE` still matches the
   ...
   read-only Actions allowlist/full-SHA, Pages, tag-policy, owner-review, fingerprint,
   signing-secret-name, and protected free-OpenRouter/private-endpoint readiness checks all pass.
