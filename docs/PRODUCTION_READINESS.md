...
|---|---|---|---|
| Public-use license | Anyone receiving the public release has explicit terms permitting installation and use. | The copyright holder selected Apache-2.0 on 2026-07-15. Every workspace package inherits the exact `Apache-2.0` SPDX identity, the repository retains the canonical license text, each publishable SDK crate embeds a drift-checked copy, and the real-checkout plus fixture validators pass. | P0 acceptance is complete. |
