...
The helper currently pins Chrome for Testing Headless Shell `151.0.7922.71`, archive size
`120170857`, and SHA-256
`7dd9d23b46fa7a9bfa26f1af96f413e0514c32698f6a43a57e1ade48d88a6578`. It uses HTTPS, rejects an
...
`HeadlessChrome/151.0.7922.71`, and CDP `1.3` identity.
