...
pub use registry::{
    ...
    REGISTRY_SNAPSHOT_PAYLOAD_TYPE, RegistryContentDescriptor, RegistryDependencyLock,
    RegistryError, RegistryMetadataStore, RegistryMetadataStoreError, RegistryPackageKind,
    RegistryPublicKey, RegistryPublisher, RegistryRelease, RegistrySignature,
    RegistrySignatureAlgorithm, RegistrySignedEnvelope, RegistrySnapshot, RegistrySnapshotCommit,
    RegistrySnapshotState, RegistryTarget, RegistryTrustRoot, RegistryTrustRootCommit,
    RegistryTrustRootState, RegistryUseCaseError, RegistryWithdrawal, SkillPermissionDiff,
    accept_registry_snapshot, bootstrap_registry_trust_root, diff_extension_permissions,
    diff_skill_permissions, inspect_initial_registry_trust_root, inspect_registry_release,
    inspect_registry_root_rotation, inspect_registry_snapshot, rotate_registry_trust_root,
};
pub use schedule::{
